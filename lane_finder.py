...
def find_lane_pixels(binary_warped):
    ...
    factor = int(histogram.shape[0]//12.8)
    leftx_base = (np.argmax(histogram[factor:midpoint]) + factor*3) // 3
    rightx_base = np.argmax(histogram[midpoint:histogram.shape[0]-factor*3])//3 + midpoint
